...
/* harmony import */ var _modules_searchMeal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/searchMeal */ "./src/modules/searchMeal.js");


(0,_modules_renderform__WEBPACK_IMPORTED_MODULE_0__["default"])(); // generate form
(0,_modules_searchMeal__WEBPACK_IMPORTED_MODULE_1__["default"])();
...
var ajaxService = function ajaxService(term) {
  ...
  // const key = "1";
  return fetch("".concat(url).concat(term)).then(function (response) {
...
var searchMeal = function searchMeal() {
